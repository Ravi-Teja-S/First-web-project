...
<body>
        ...
        <div class="banner-content">
            <div class="banner-left">
                <div class="banner-text">
                    <h1>TRADITIONAL ARTS OF INDIA</h1>
                    <p>Discover the timeless beauty and rich cultural heritage of India's traditional arts and crafts
                    </p>
                    <a href="/about-us" class="explore-btn" id="explore-btn" style="text-decoration:none;">EXPLORE NOW</a>
                </div>
            </div>
            <div class="banner-right">
                <div class="banner-image-container">
                    <img src="/img/fotor-2025040321114.png" alt="Logo" class="banner-image">
                </div>
            </div>
        </div>
    </div>
    ...
    <footer>
        <div class="footer-content">
            <div class="footer-section">
                ...
                <ul>
                    ...
                    <li><a href="/about-us">Artists</a></li>
            ...
            <div class="footer-section">
                ...
                <ul>
                    <li><a href="/shop-now">Shipping</a></li>
                    <li><a href="/shop-now">Returns</a></li>
                    <li><a href="/snop-now">FAQs</a></li>
                </ul>
            </div>
            <div class="footer-section">
                <h3>Legal</h3>
        ...
        <div class="footer-bottom">
            <p>&copy; 2025 Traditional Arts of India. All rights reserved.</p>
        </div>
    </footer>
